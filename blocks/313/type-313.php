<div class="type-313">
    <div class="container">      
        <div class="row" style="margin-top:30px;">
            ...
            <div class="clearfix"></div>
            <h3>How About Circle Frame?</h3>
            <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 margin">              
                <div class="demo nhan-2">
                    <a href="#">
                        <img class="tron" src="images/2.jpg">
                        <div class="overlay thumb"></div>
                        <div class="text thumb">
                            <i class="fa fa-search icon" aria-hidden="true"></i>
                        </div>
