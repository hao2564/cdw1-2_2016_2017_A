<div class="type-318">
    <div class="container">
        <div class="row">  
            <div class="col-md-8 col-xs-12 col-lg-8 col-sm-8 margin">
                <h3>Tabs</h3>
                <ul class="tabs">
                    <li class="active" rel="tab1">Tab Title 1</li>
                    <li rel="tab2">Tab Title 2</li>
                    <li rel="tab3">Tab Title 3</li>                 
                </ul>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body">
                                [gdlr_post_slider category="19" num_fetch="4" num_excerpt="25" caption_position="bottom" <br>
                                thumbnail_size="post-slider-bottom" orderby="date" order="asc" ]
                            </div>
                        </div>
                    </div>
                 </div>
                ...
                <ul class="tabs">
                    <li class="active" rel="tab4"><i class="fa fa-file" aria-hidden="true"></i>Tab Title 1</li>
                    <li rel="tab5"><i class="fa fa-sun-o" aria-hidden="true"></i>Tab Title 2</li>
                    <li rel="tab6"><i class="fa fa-truck" aria-hidden="true"></i>Tab Title 3</li>                 
                </ul>
                <div class="tab_container">
