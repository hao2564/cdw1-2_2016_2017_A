        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-xs-12 col-sm-6">
                    <div class="gdlr-item" style="margin-bottom: 60px;">
                        <p></p>
                        <div class="clear"></div>
                            ...
                            <form action="/realsoccer/demo2/contact-page/#wpcf7-f4-o1" method="post" novalidate="novalidate">
                                ...
                                <p>Your Name (required)<br>
                                    <span class="wpcf7-form-control-wrap">
                                        <input type="text" name="your-name" value="" size="40" class="wpcf7-form-control" aria-required="true" aria-invalid="false"></span> </p>
                                <p>Your Email (required)<br>
                                    <span class="wpcf7-form-control-wrap">
                                        <input type="email" name="your-email" value="" size="40" class="wpcf7-form-control" aria-required="true" aria-invalid="false"></span> </p>
                                <p>Subject<br>
                                    <span class="wpcf7-form-control-wrap">
                                        <input type="text" name="your-subject" value="" size="40" class="wpcf7-form-control" aria-invalid="false"></span> </p>
                                <p>Your Message<br>
                                    <span class="wpcf7-form-control-wrap">
                                        <textarea name="your-message" cols="40" rows="10" class="wpcf7-form-control" aria-invalid="false"></textarea></span> </p>
                                <p><input type="submit" value="Send" class="wpcf7-form-control"><span></span></p>
                            </form>                             
                        </div>
                    </div>
                </div>
