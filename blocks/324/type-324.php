                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                        <div class="panel-body">
                            ...
                            [gdlr_box_icon icon="icon-coffee" icon_type="circle" icon_color="#ffffff" 
                            icon_position="top" title="icon on the top" ]Curabitur blandit tempus porttitor. Cras justo odio,<br> 
                            dapibus ac facilisis in, egestas eget quam. Aenean eu leo quam. [/gdlr_box_icon]<br><br>

                            [/gdlr_column]<br><br>

                            [gdlr_column size="1/3"]<br><br>

                            [gdlr_box_icon icon="icon-dropbox" icon_type="circle" icon_color="#ffffff" icon_background="#4984d5" 
                            icon_position="top" title="icon on the top" ]Curabitur blandit tempus<br> porttitor. Cras justo odio,
                            dapibus ac facilisis in, egestas eget quam. Aenean eu leo quam. [/gdlr_box_icon]<br><br>

                            [/gdlr_column]<br><br>

                            [/gdlr_row]<br>
                            [gdlr_space height="10px"]<br>
                            [gdlr_row]<br><br>

                            [gdlr_column size="1/2"]<br><br>
